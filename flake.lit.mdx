      ...
      cli = pkgs.writeShellScriptBin "literate-state-machine-wiki" ''
        ...
        case "''${1:-}" in
          ...
          *)
            ...
            echo ""
            echo "TaskNotes ops use the upstream CLIs directly:"
            echo "  mtn create '<text>'                 (standalone TaskNote, no Obsidian needed)"
            echo "  mtn list --json                     (enumerate standalones)"
            echo "  obsidian tasknotes:capture vault=X text='...'  (live, NLP-parsed)"
            exit 1
            ;;
        esac
      '';
